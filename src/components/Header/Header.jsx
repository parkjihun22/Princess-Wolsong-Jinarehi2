...
const T = {
  ...
  mainMenu: "주요 메뉴",
  logoAlt: "공주 월송 진아레히 로고",
  bannerAlt: "공주 월송 진아레히 방문예약 안내 배너",
};
...
const menuArray = [
  ...
  },
  {
    ...
    subMenu: [
      ...
      { subTitle: "104㎡", subUrl: "/FloorPlan/84A" },
      { subTitle: "116㎡", subUrl: "/FloorPlan/84B" },
      { subTitle: "132㎡", subUrl: "/FloorPlan/114A" },
